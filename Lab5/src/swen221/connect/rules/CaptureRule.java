...
public class CaptureRule implements Rule {
	 ...
	 * @return
	 */
	public static void checkCaptured(Board current, Board original, int x, int y) {
	 ...
	 * @return
	 */
	private static boolean isCaptured(Board original, Board.Token token, int x, int y) {
		boolean r = false;
	 ...
	 * @return
	 */
	private static boolean isHorizontalLongCapture(Board original, Board.Token token, int x, int y) {
		if (x == 1 || x == 2) {
	 ...
	 * @return
	 */
	private static boolean isHorizontalShortCapture(Board original, Board.Token token, int x, int y) {
		if (x == 1 || x == 2) {
	 ...
	 * @return
	 */
	private static boolean isVerticalLongCapture(Board original, Board.Token token, int x, int y) {
		if (y == 1 || y == 2) {
	 ...
	 * @return
	 */
	private static boolean isVerticalShortCapture(Board original, Board.Token token, int x, int y) {
		if (y == 1 || y == 2) {
	 ...
	 * a given token on the board, what color the pieces are which could
	 * capture it.
	 *
	 * @param token
	 * @return
	 */
	private static Board.Token getOpposite(Board.Token token) {
