...
import swen221.widgets.Background;
import swen221.widgets.Counter;
import swen221.widgets.Toggle;
...
public class Main {
	 ...
	 */
	public static final Class<? extends Widget>[] ARRAY_OF_ALL_WIDGETS = new Class[] {
			Background.class,
			Toggle.class,
			getClassFromBytes("swen221.widgets.Counter", Counter.COUNTER_BYTES) };
