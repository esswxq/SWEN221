...
public class WidgetTests {
	...
	public void test01_newWidget() {
		...
		assertEquals(new Rectangle(0,0,200,200),background.getDimensions());
	}
	...
	public void test02_Toggle() {
		...
		assertEquals(Boolean.TRUE,inspector.getAttributeValue(toggleA, "value"));
		assertEquals(Boolean.FALSE,inspector.getAttributeValue(toggleB, "value"));
	}
	...
	public void test03_Toggle() {
		...
		playEventSequence(clicks,background);
		// Finally, check things happened as we expected
		assertEquals(Boolean.FALSE,inspector.getAttributeValue(toggle, "value"));
	}
	...
	public void test05_Toggle() {
		...
		playEventSequence(clicks,background);
		// Finally, check things happened as we expected
		assertEquals(Boolean.FALSE,inspector.getAttributeValue(toggleA, "value"));
		assertEquals(Boolean.TRUE,inspector.getAttributeValue(toggleB, "value"));
	}
	...
	public void test06_Counter() {
		...
		playEventSequence(clicks,background);
		// Finally, check things happened as we expected
		assertEquals(3,inspector.getAttributeValue(counterA, "value"));
	}
	...
	public void test07_Counter() {
		...
		// Finally, check things happened as we expected
		assertEquals(3,inspector.getAttributeValue(counterA, "value"));
		assertEquals(6,inspector.getAttributeValue(counterB, "value"));
	}
