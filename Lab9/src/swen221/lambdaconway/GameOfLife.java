...
import swen221.lambdaconway.util.*;
...
public class GameOfLife {
	...
	/**
	 * Count the number of neighbours for a cell at a given point on a given
	 * board.
	 * 
	 * @param pair
	 *            The point and board package up to make it easier to access
	 *            from a lambda rule.
	 * @return
	 */
